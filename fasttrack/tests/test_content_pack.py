...
class ContentPackTests(unittest.TestCase):
    ...
    def test_writes_reviewable_pack_files(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertTrue((output / "platforms" / "instagram.json").exists())
            self.assertTrue((output / "platforms" / "tiktok.json").exists())
            self.assertTrue((output / "platforms" / "pinterest.json").exists())
